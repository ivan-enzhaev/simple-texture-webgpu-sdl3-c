...
static WGPUSurface CreateWGPUSurface(WGPUInstance inst, SDL_Window *win)
{
    ...
    desc.nextInChain = (WGPUChainedStruct *)&canvasSource;
    ...
    void *userdata2)
{
    ...
    if (status == WGPURequestAdapterStatus_Success)
    {
        ...
        WGPUUncapturedErrorCallbackInfo errorCallbackInfo = { 0 };
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    adapterCallbackInfo.callback = (WGPURequestAdapterCallback)handle_adapter_request;
